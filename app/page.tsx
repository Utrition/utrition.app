    ...
    <main className="overflow-x-hidden">
      ...
      <header className="container mx-auto px-6 py-8 flex justify-between items-center">
        ...
        <div className="flex items-center gap-4">
          <ThemeToggle />
          <button className="px-6 py-2 bg-[#00D37F] text-white rounded-[50px] hover:bg-[#00B26C] transition duration-300">
            Sign Up
          </button>
        </div>
      </header>
        ...
        <div className="bg-[#F7F7F7] dark:bg-gray-800 rounded-3xl p-8 md:p-12">
          <div className="flex flex-col md:flex-row gap-8 md:gap-16">
            ...
            <div className="md:w-1/2">
              <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300">
                With endless options and confusing labels, healthy eating can feel overwhelming. Whether you're short on
                time or unsure where to start, finding the right foods shouldn't be this hard.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 mt-12">
            <div className="text-center">
              <p className="text-5xl md:text-6xl lg:text-7xl font-normal text-[#00D37F] mb-4">20%</p>
              <p className="text-lg dark:text-gray-300">Say it's a lack of knowledge</p>
            </div>
            <div className="text-center">
              <p className="text-5xl md:text-6xl lg:text-7xl font-normal text-[#00D37F] mb-4">23%</p>
              <p className="text-lg dark:text-gray-300">Think it takes too much time</p>
            </div>
            <div className="text-center">
              <p className="text-5xl md:text-6xl lg:text-7xl font-normal text-[#00D37F] mb-4">40%</p>
              <p className="text-lg dark:text-gray-300">Believe it is too expensive</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-[#F7F7F7] dark:bg-gray-800 rounded-[20px] p-8">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              We are only as strong as those around us. We're creating a place for you, our users, to follow and share
              your friends' interests and preferences.
            </p>
          </div>
          ...
          <div className="bg-[#F7F7F7] dark:bg-gray-800 rounded-[20px] p-8">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              We enable you to set up your personalized account ready for you to shop and swipe away using only your
              pantry items and our brief questionnaire.
            </p>
          </div>
          ...
          <div className="bg-[#F7F7F7] dark:bg-gray-800 rounded-[20px] p-8">
            ...
            <h3 className="text-2xl font-normal mb-4">Artificial Intelligence</h3>
            <p className="text-gray-600 dark:text-gray-300">
              We are harnessing the power of AI to create personalized product and recipe recommendations specifically
          ...
          <div className="bg-[#F7F7F7] dark:bg-gray-800 rounded-[20px] p-8">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              We enable you to make your own informed consumer decisions based on credible, unbiased information.
            </p>
          </div>
          ...
          <div className="bg-[#F7F7F7] dark:bg-gray-800 rounded-[20px] p-8">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              We are partnering with curated organizations including clubs, wellness centers, and gyms to help navigate
      ...
      <section className="container mx-auto px-6 py-16 md:py-24">
        <div className="bg-[#1E1E1E] dark:bg-gray-900 rounded-[38px] p-8 md:p-16 text-center text-white max-w-[1359px] mx-auto shadow-lg">
          ...
          <p className="text-lg md:text-xl max-w-3xl mx-auto mb-8 text-white">
            Take the guesswork out of food choices. Join <span className="text-[#00D37F] font-normal">UTRITION</span> and
            get personalized recommendations tailored to your lifestyle.
          </p>
          <button className="px-8 py-3 bg-[#00D37F] text-white rounded-[50px] hover:bg-[#00B26C] transition duration-300">
            Sign Up
          </button>
        </div>
      </section>
